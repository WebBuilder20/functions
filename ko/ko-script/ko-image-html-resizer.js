let ERROR_LengWH = 'ERROR : 가로와 세로 길이가 정상 입력되지 않았습니다.'
let ERROR_LengW = 'ERROR : 가로 길이가 정상 입력되지 않았습니다.'
let ERROR_LengH = 'ERROR : 세로 길이가 정상 입력되지 않았습니다.'
let ERROR_INW_LengWH = 'ERROR : 원본 HTML 가로와 세로 길이가 정상 입력되지 않았습니다.'
let ERROR_INW_LengW = 'ERROR : 원본 HTML 가로 길이가 정상 입력되지 않았습니다.'
let ERROR_INW_LengH = 'ERROR : 원본 HTML 세로 길이가 정상 입력되지 않았습니다.'
