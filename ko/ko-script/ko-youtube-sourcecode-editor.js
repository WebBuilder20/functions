...
var ERROR_notProperSC = "ERROR : 유튜브 소스코드가 정상적이지 않습니다.";
var ERROR_LengWH = 'ERROR : 가로와 세로 길이가 정상 입력되지 않았습니다.';
var ERROR_LengW = 'ERROR : 가로 길이가 정상 입력되지 않았습니다.';
var ERROR_LengH = 'ERROR : 세로 길이가 정상 입력되지 않았습니다.';
